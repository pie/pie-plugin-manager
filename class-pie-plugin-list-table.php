...
if ( ! class_exists( 'PiePluginListTable' ) ) {
	class Pie_Plugin_List_Table extends \Wp_List_Table {
		private $plugin_paths;
		private $plugin_states;

		public function __construct( $plugin_paths = array(), $plugin_states = array() ) {
			parent::__construct(
				array(
		...
		public function prepare_items() {
			...
			$hidden                = array( 'plugin-data', 'plugin_state' );
			$sorted                = array(
	...
	$table = new Pie_Plugin_List_Table( $this->plugin_paths, $this->plugin_states );
	$table->prepare_items();
	$table->display();
}
